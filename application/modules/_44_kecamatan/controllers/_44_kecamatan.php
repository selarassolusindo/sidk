...
class _44_kecamatan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . '_44_kecamatan/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . '_44_kecamatan/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . '_44_kecamatan/index.html';
            $config['first_url'] = base_url() . '_44_kecamatan/index.html';
        }
	...
	foreach ($this->_44_kecamatan_model->get_all() as $data) {
	    ...
	    xlsWriteLabel($tablebody, $kolombody++, $data->kabupaten_id);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2021-03-12 16:47:38 */
/* http://harviacode.com */