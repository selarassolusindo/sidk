                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="td-actions text-right">
                                        <a href="<?php echo site_url('_41_agama/read/'.$_41_agama->idagama); ?>" type="button" rel="tooltip" class="btn btn-info">
                                            <i class="material-icons">pageview</i>
                                        </a>
                                        <a href="<?php echo site_url('_41_agama/update/'.$_41_agama->idagama); ?>" type="button" rel="tooltip" class="btn btn-success">
                                            <i class="material-icons">edit</i>
                                        </a>
                                        <a href="<?php echo site_url('_41_agama/delete/'.$_41_agama->idagama); ?>" type="button" rel="tooltip" class="btn btn-danger" onclick="javascript: return confirm('Are You Sure ?')">
